...
CREATE TABLE `Users` (
  ...
  `LINE_Token` varchar(1000) DEFAULT NULL,
  `LINE_USER_ID` varchar(200) DEFAULT NULL,
  `LINE_CONFIRM_HASH` char(64) DEFAULT NULL,
  `LINE_CONFIRM_TIME` datetime DEFAULT NULL,
  `LINE_CONFIRMED` bit(1) NOT NULL DEFAULT b'0',
  `LINE_COMMAND_CD_TIME` datetime DEFAULT NULL,
  PRIMARY KEY (`SN`)
