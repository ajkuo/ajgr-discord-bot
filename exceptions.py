...
class AJGRbotException(Exception):
...
class CommandError(AJGRbotException):
    pass

# Something went wrong during the processing of a song/ytdl stuff
class ExtractionError(AJGRbotException):
    pass
